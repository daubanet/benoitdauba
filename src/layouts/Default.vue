  ...
  <div class="content-wrapper bg-background-primary font-sans text-copy-primary leading-normal flex flex-col min-h-screen" :class="theme">
    <header class="border-t-14 border-green-700">
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
        <div>
          <g-link v-if="theme === 'theme-light'" to="/"><g-image src="../../static/logo@2x.svg" class="" alt="logo" /></g-link>
          <g-link v-else to="/"><g-image src="../../static/logo@2x.svg" class="" alt="logo" /></g-link>
        </div>
        ...
        >
          ...
          <li>
            <g-link to="/blog" class="mr-8 mb-6 lg:mb-0 text-copy-primary hover:text-gray-600">Blog</g-link>
          </li>
          <li class="mr-8 mb-6 lg:mb-0">
          ...
          <li class="mr-8 mb-6 lg:mb-0">
             <a href="/CV_Benoit_Dauba.pdf" class="text-copy-primary hover:text-gray-600">Mon CV</a>
          </li>
          <li >
    ...
    <footer class="bg-green-700 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        ...
        <ul class="flex items-center">
          <li class="mr-8">
            <a href="mailto:benoit@dauba.net" class="text-white hover:text-gray-400">
          ...
          <li class="mr-8">
            <a href="https://github.com/daubanet" target="_blank" class="text-white hover:text-gray-400">
